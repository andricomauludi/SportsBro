        ...
        Glide.with(holder.img.getContext())
                ...
                holder.img.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper, new DetailLapangan(model.getNamatempat(),model.getMarker(),model.getGambar(),model.getAlamattempat(),model.getIdtempat())).addToBackStack(null).commit();
                    }
                });
